 ...
 * 
 * TrakingMain es la clase principal, se encarga de mostrar en pantalla la imagen obtenida desde
 * la webcam y la trayectoria de los objetos detectados en la imagen.
 * 
