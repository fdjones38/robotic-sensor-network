 ...
 * Esta clase utiliza las herramientas de javacv para el reconocimiento de objetos de color AZUL.
 * 
...
public class Object_2 implements Runnable {
    ...
    private final int INTERVAL = 10;    //Intervalo de tiempo para el hilo.
     ...
     * El color para este objeto es el ROJO que va de un tono oscuro (rgba_minBLUE)
     * a un tono más claro (rgba_maxBLUE).
     ...
     */
    static CvScalar rgba_minBLUE = cvScalar(64, 10, 11, 0); //Oscuro
    static CvScalar rgba_maxBLUE = cvScalar(242, 75, 81, 0); //Claro
    
    private Thread thread;  //Hilo para grabación y reconocimiento del objeto.
    private int ii = 0;     //Contador de imagenes capturadas.
    
    public Object_2(){
        thread = new Thread(this, "Object 2: Blue."); //Se crea el hilo.
        ...
        try {
            ...
            while (true) {
                ...
                if (img != null) {
                    ...
                    //TrakingMain.showVideo(img); La imagen de la webcam ya se esta mostrando en pantalla desde Object_1
                    ...
                    if (posX > 0 && posY > 0) {
                        TrackingMain.paint(img, posX, posY, Color.BLUE);
                    }
                }
    ...
    private IplImage getThresholdImage(IplImage orgImg) {
        ...
        cvInRangeS(orgImg, rgba_minBLUE, rgba_maxBLUE, imgThreshold);
